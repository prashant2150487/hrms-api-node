...
import { createCustomRole, getAllPermissions, getAllRoles, getPermissionOnRole } from "../../controllers/roleController.js"
...
router.post("/:role_id/permission", auth, abac("roles:read", { allowedRoles: ["admin", "hr_admin"] }), getPermissionOnRole)
